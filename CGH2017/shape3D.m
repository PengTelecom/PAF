...
switch shape %le switch en matlab ne marche pas comme le switch en C. Notamment les breaks sont inutiles.
    case 'cube'
        object = zeros((N-2*padding)*12-16,3);% Nombre de points=pixels qui représentent le cube (12 arrêtes. Il y a 8 points qu'on compte 2 fois car il  y a 8 sommets)       
        ...
        object = object - 11;
        object = object - [14,14,0];
        object= pas_pixel*object; %On retourne les coordonnées en m et non plus en pixels. De plus , on met bien l'orgine ?0 et non ?(1,1).
